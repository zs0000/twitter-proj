...
return(
  ...
  <div className={s.modalcontainer}>
    ...
    <span className={s.replyingto}> Replying to <span className={s.replyhandle}>{replyPost ?"@"+ replyPost.author_handle : ""}</span></span>
    </div>
