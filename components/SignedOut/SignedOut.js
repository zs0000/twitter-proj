...
export default function SignedOut(){
    ...
    return(
        ...
        {isOpen === false ? <></> : <SignIn isOpen={isOpen} setIsOpen={setIsOpen} onClick={handleSignInOpen} />}
       <div className={s.imgbarlarge}>
         ...
         <div className={s.content}>
           ...
           <button onClick={()=>alert("These buttons are just for looks. Click sign in under 'Already have an account' and use any email.")}  className={s.button}>
           ...
           <button onClick={()=>alert("These buttons are just for looks. Click sign in under 'Already have an account' and use any email.")}  className={s.applebutton}>
           ...
           <button onClick={()=>alert("These buttons are just for looks. Click sign in under 'Already have an account' and use any email.")} className={s.signupbutton}>
